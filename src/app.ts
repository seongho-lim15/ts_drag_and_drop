...
class ProjectList {
  ...
  constructor(private type : 'active' | 'finished') {
    ...
    this.projectState.addListener((projects: any[]) =>{
...
class ProjectInput {
  ...
  constructor() {
    ...
    this.hostElement = document.getElementById('app')! as HTMLDivElement;
    this.proejectState = ProjectState.getInstance();
  ...
  private submitHandler(event: Event) {
    ...
    if (Array.isArray(userInput)) {
      ...
      this.proejectState.addProject(title, desc, people);
      this.clearInputs();
    }
  }
